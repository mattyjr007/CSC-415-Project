...
key1 = driver.find_element_by_xpath(".//a[@href='/tutorials/lab_video/116/1']").click()
...
key2 = driver.find_element_by_xpath(".//a[@href='/tutorials/lab_video/35/3']").click()
...
key4 = driver.find_element_by_xpath(".//a[@href='/tutorials/lab_video/74/6']").click()
...
key5 = driver.find_element_by_xpath(".//a[@href='/tutorials/lab_video/53/4']").click()
...
key6 = driver.find_element_by_xpath(".//a[@href='/tutorials/lab_video/83/7']").click()
